...
import { unicodeToBijoy } from '../utils/bijoy';
...
export const DqTab: React.FC = () => {
  ...
  const [activeSetTab, setActiveSetTab] = useState<string>('all');
  ...
  return (
    <div className="space-y-4 font-solaiman">
      {/* Toast */}
      {toastMsg && (
      ...
      <div className="p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                DQ : প্রশ্ন বিভাজন (Divide Questions)
                <span className="text-xs bg-emerald-100 text-emerald-800 px-2.5 py-0.5 rounded-full border border-emerald-300 font-semibold">
                  Smart Splitter
                </span>
              </h1>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={loadSample}
              className="text-xs bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold px-3 py-1.5 rounded-lg border border-emerald-300 transition flex items-center gap-1.5 cursor-pointer shadow-2xs"
            >
